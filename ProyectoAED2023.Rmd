...
outbox <- list()
for (i in 1:24){
outbox[i] <- list(reglaboxplot(ValenBisi_por_tramo[[i]]$numero_de_devoluciones))
}
```
...
out3sig <- list()
for (i in 1:24){
out3sig[i] <- list(reglasigma(ValenBisi_por_tramo[[i]]$numero_de_devoluciones))
}
...
outham <- list()
for (i in 1:24){
outham[i] <- list(reglahampel(ValenBisi_por_tramo[[i]]$numero_de_devoluciones))
}
...
outper <- list()
for (i in 1:24){
outper[i] <- list(reglapercentil(ValenBisi_por_tramo[[i]]$numero_de_devoluciones))
}
```
