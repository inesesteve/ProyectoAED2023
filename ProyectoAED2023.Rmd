...
interactive_boxplot <- plot_ly(ValenBisi, x = ~get(initial_x), y = ~numero_de_devoluciones, type = "box", text = ~estacion)
...
interactive_boxplot2 <- plot_ly(ValenBisi, x = ~get(initial_x), y = ~numero_de_prestamos, type = "box", text = ~estacion)
